...
// -----------------------------
  ...
  _getDimensionHandleWorldTargets() {
    ...
    return {
      top: new THREE.Vector3(center.x, y, box.min.z - out),
      bottom: new THREE.Vector3(center.x, y, box.max.z + out),
      left: new THREE.Vector3(box.min.x - out, y, center.z),
      right: new THREE.Vector3(box.max.x + out, y, center.z)
    };
  }
