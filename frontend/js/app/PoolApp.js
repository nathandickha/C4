...
export class PoolApp {
  ...
  _getPoolScreenBounds() {
    ...
    for (const corner of corners) {
      ...
      if (!Number.isFinite(projected.x) || !Number.isFinite(projected.y) || projected.z < -1.2 || projected.z > 1.2) continue;
    ...
    if (!visibleCount || !Number.isFinite(minX) || !Number.isFinite(maxX) || !Number.isFinite(minY) || !Number.isFinite(maxY)) {
      return null;
    }
