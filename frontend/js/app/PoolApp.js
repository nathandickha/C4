...
export class PoolApp {
  ...
  _getPoolHandleWorldPosition(axis) {
    ...
    if (axis === "x+") point.x = bounds.max.x;
    else if (axis === "x-") point.x = bounds.min.x;
    else if (axis === "z+") point.z = bounds.max.z;
    else if (axis === "z-") point.z = bounds.min.z;

    point.y = bounds.max.y + 0.02;
    return point;
  }
