...
// -----------------------------
  ...
  _getPoolHandleWorldPosition(axis) {
    ...
    if (axis === "x-") {
      point.set(box.min.x - outward, box.max.y + lift, center.z);
    } else if (axis === "x+") {
      point.set(box.max.x + outward, box.max.y + lift, center.z);
    } else if (axis === "z+") {
      point.set(center.x, box.max.y + lift, box.max.z + outward);
    } else if (axis === "z-") {
      point.set(center.x, box.max.y + lift, box.min.z - outward);
    } else {
      return null;
    }
